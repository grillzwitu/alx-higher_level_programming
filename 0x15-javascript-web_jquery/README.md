...
* [jQuery Ajax Tutorial #1 - Using AJAX & s](https://intranet.hbtn.io/rltoken/Rq2Ob5rhN-N458YBxxaRXQ)
...
* Write a Javascript script that updates the text of the HTML tag HEADER New  when the user clicks on DIV#update_header
...
* Write a Javascript script that fetches from https://fourtonfish.com/hellosalut/?lang=fr and displays the value of hello from that fetch in the s tag DIV#hello.

---

## Author
* **Tare Appah** - [grillzwitu](https://github.com/grillzwitu)
